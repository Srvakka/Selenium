...
public class Tatoc 
{
  ...
  @Test(priority = 3)
  public void box1andbox2areofsamecolor()
  {
     String box1;
    String box2;
    boolean b= true;
  ...
  while(b)
    ...
    if(box1.equals(box2))
		...
		System.out.println("Successfully matched the color of box1 and box2 and proceed button have been clicked");
  }
  @Test(priority = 4)
  public void draganddropfunction() {
		...
		driver.findElement(By.linkText("Proceed")).click();
		System.out.println("Successful drag and drop action have been done ");
  }
  @Test(priority = 5)
  public void newwindowandsearchsomething()
  {
	  driver.findElement(By.linkText("Launch Popup Window")).click();
	   ...
	   for( String xyz : driver.getWindowHandles())
	   {
	    ...
	    System.out.println("Successfully opening of the new tab and submitting entry and back to parent page");
  }
  @Test(priority = 6)
